...
<head>
    ...
    <style>
        ...
        .admin-sidebar {
            background: linear-gradient(135deg, #3b3658 0%, #4f46e5 100%);
            color: white;
            padding: 20px;
            position: fixed;
            height: 100vh;
    ...
    <div class="admin-container">
        ...
        <div class="admin-content">
                        ...
                        <div class="form-grid">
                            ...
                            <div class="form-group">
                                ...
                                <?php if ($edit_project && !empty($edit_project['gambar'])): ?>
                                    <p style="margin-top:8px; font-size:13px; color:#9aa4b2;">
            ...
            <!-- ============================================
                 ...
                 ============================================ -->
            <div style="clear: both; margin-top: 50px; padding-top: 20px; border-top: 2px solid #1f2937; background: #0f1724; padding: 15px; border-radius: 5px;">
                <h2 style="margin: 20px 0; color: #e6eef8; border-bottom: 2px solid #4f46e5; padding-bottom: 10px; font-size: 24px;">
            ...
            <div class="projects-list">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php if (!empty($project['link'])): ?>
                                                <a href="<?php echo htmlspecialchars($project['link']); ?>" target="_blank" style="color: #a78bfa;">
                                                    Lihat →
                                                </a>
                                            <?php else: ?>
                                                <span style="color: #93a4b8;">-</span>
                                            <?php endif; ?>
                                        </td>
                ...
                <p style="margin-top: 20px; text-align: center; color: #9aa4b2;">
