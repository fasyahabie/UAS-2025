    ...
    <section class="hero">
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    <h1>Halo, Saya Vahrel FasyaHabie</h1>
                    <p class="hero-subtitle">Mahasiswa Informatika</p>
                    
                    <div class="hero-description">
                        <p>
                            Saya adalah mahasiswa Informatika semester 3 yang memiliki ketertarikan besar pada dunia teknologi dan pengembangan perangkat lunak. Saat ini saya aktif mempelajari dasar–dasar pemrograman web, basis data, serta konsep algoritma dan struktur data sebagai fondasi dalam pengembangan sistem informasi dan aplikasi.
                        </p>
                        <p>
                            Sebagai mahasiswa Informatika, saya berkomitmen untuk terus meningkatkan keterampilan teknis maupun soft skill, serta siap berkembang menjadi individu yang adaptif terhadap perkembangan teknologi yang pesat.
                        </p>
                    </div>
        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    <h4>Social Media</h4>
                    <ul>
                        <li><a href="https://github.com/fasyahabie" target="_blank">GitHub</a></li>
